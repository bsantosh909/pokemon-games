<template>
  <div class="flex flex-wrap">
    <div v-for="game of games" :key="game.id" class="w-full md:w-1/2">
      <div class="m-4 bg-gray-100 sh rounded-sm shadow-md px-3 py-2">
    ...
    const games = [
      {
        ...
        id: "guess-that-pokemon",
        description: 'The classic "Who is that Pokemon?"',
      ...
      },
      {
        ...
        description:
          "Kanto to Galar, Try your best to name them all by the region they originated from!",
      ...
      },
      {
        ...
        id: "name-by-type",
        description:
          "Beautify fairy types or fierce dragon types, Try your best to name them all by the their types!",
        difficulty: ["medium", "hard"],
      },
      {
        ...
        description:
          "Guess the Pokemon based upon it's pokedex description from one of many games!",
        difficulty: ["hard"],
      },
    ];
    return {
